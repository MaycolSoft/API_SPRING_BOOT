...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TTipoTarjeta.findAll", query = "SELECT t FROM TTipoTarjeta t"),
    @NamedQuery(name = "TTipoTarjeta.findByFIdrecord", query = "SELECT t FROM TTipoTarjeta t WHERE t.fIdrecord = :fIdrecord"),
    @NamedQuery(name = "TTipoTarjeta.findByFIdempresa", query = "SELECT t FROM TTipoTarjeta t WHERE t.fIdempresa = :fIdempresa"),
    @NamedQuery(name = "TTipoTarjeta.findByFDescripcion", query = "SELECT t FROM TTipoTarjeta t WHERE t.fDescripcion = :fDescripcion")})
public class TTipoTarjeta implements Serializable {
    ...
    public TTipoTarjeta(Integer fIdrecord) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TTipoTarjeta)) {
            return false;
        }
        TTipoTarjeta other = (TTipoTarjeta) object;
    ...
    public String toString() {
        return "jqmicrosistemas.abacus.model.TTipoTarjeta[ fIdrecord=" + fIdrecord + " ]";
    }
